...
export const env = {
  ...
  DATABASE_NAME: process.env.DATABASE_NAME || 'hyra-platform',
  BUILD_MODE: process.env.NODE_ENV || 'dev',
  APP_SECRET: process.env.APP_SECRET as string,
  ACCESS_TOKEN_EXPIRES_IN: (process.env.ACCESS_TOKEN_EXPIRES_IN as string) || '30m',
  ...
  GMAIL_USER: process.env.GMAIL_USER || 'congquynguyen296@gmail.com',
  GMAIL_PASS: process.env.GMAIL_PASS || 'congquynguyen296',
